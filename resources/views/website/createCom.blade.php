...
<html lang="en">
  ...
  <body>
    ...
    <div class="w-75 m-4">
        ...
        <input class="form-control form-control-lg" type="text" placeholder="Company Country" aria-label=".form-control-lg example">
        <input class="form-control form-control-lg" type="text" placeholder="Company City" aria-label=".form-control-lg example">
